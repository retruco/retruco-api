...
swaggerMiddleware.init(swaggerSpecification, function (/* err */) {
  ...
  app.get("/objects/:idOrSymbol/debate-properties", usersController.authenticate(false),
    objectsController.requireObject, objectsController.listObjectDebateProperties)
  app.get("/objects/:idOrSymbol/next-properties", usersController.authenticate(false),
